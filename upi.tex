...
\AgdaFunction{toffoli} &=&
      \bt \otimes (\bt \otimes \bt) \\
&& \qquad\byiso{\AgdaFunction{unfoldBool} \otimes \AgdaFunction{id}} \\
&& (\ot \oplus \ot) \otimes (\bt \otimes \bt) \\
&& \qquad\byiso{\AgdaFunction{dist}} \\
&& (\ot \otimes (\bt \otimes \bt)) \oplus (\ot \otimes (\bt \otimes \bt)) \\
&& \qquad\byiso{\AgdaFunction{id} \oplus (\AgdaFunction{id} \otimes \AgdaFunction{cnot})} \\
&& (\ot \otimes (\bt \otimes \bt)) \oplus (\ot \otimes (\bt \otimes \bt)) \\
