...
the iterates $(\permtwo)^k$ for $k \in \Z$ on the three elements we find:
...
earlier, this groupoid has cardinality $\frac{3}{2}$. From the perspective of
$\Pi$, this cardinality corresponds to the number of elements in the underlying
set which is $\mathbb{3}$ divided by the order of the combinator $\permtwo$ in
question which is 2.
