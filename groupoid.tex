...
1-combinators so that they denote information equivalent
...
programs. Depending on the precise setup, we can use 1-combinators $p$
to build one of several kinds of non-trivial groupoids: action
groupoids $\ag{\tau}{p}$, order groupoids $\order{p}$, inverse order
groupoids $\iorder{p}$, and expanded unit groupoids $\mathbb{1}_p$.
