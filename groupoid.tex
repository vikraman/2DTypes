...
Following HoTT, we think of a type as a (topological) space. To talk
about information, we think of this type or space as an abstract
system that has $N$ distinguishable states. So the type
$\mathsf{Bool}$ has 2 distinguishable states and the type
$B^3 = \mathsf{Bool} \times \mathsf{Bool} \times \mathsf{Bool}$ has 8
distinguishable states. One of these states is
$(\mathsf{true},\mathsf{false},\mathsf{false})$. The amount of
information contained in each of the 8 states is $\log 8 = 3$
bits. This is all the classical way of quantifying information.
...
\begin{proposition}
A function is logically reversible iff it is infor\-mation-preserving.
\end{proposition}
