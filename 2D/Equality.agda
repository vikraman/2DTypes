...
data [_]_≈_ : (T : U) → V T → V T → Set where
  ...
  1/#≈ : ∀ {τ x p q} → Perm.p' {τ} p ⇔ Perm.p' {τ} q → (pp qq : Perm (Prim id⟷))
        → [ 1/# x ] (pp , p) ≈ (qq , q)
...
sym≈[ # x ] (p , α) (q , β) (#≈ p') = #≈ (2! p')
sym≈[ 1/# x ] (t , p) (qq , q) (1/#≈ α .t .qq) = 1/#≈ (2! α) qq t
...
trans≈[ 1/# x ] (pp , p) (qq , q) (rr , r) (1/#≈ x₁ .pp .qq) (1/#≈ x₂ .qq .rr) = 
  1/#≈ (trans⇔ x₁ x₂) pp rr
