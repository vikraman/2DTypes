...
\]
The groupoids on either side are not categorically equivalent but they do have the same cardinality. Thus if we focus on some notion of cardinality-preserving morphisms, it is sensible to consider them equivalent. The situation is however subtle and does not directly support a notion of sums. It is studied in detail in the next section.
