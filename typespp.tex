...
\begin{figure}
  ...
  \begin{tikzpicture}[scale=0.9,every node/.style={scale=0.7},highlight/.style={line width=4pt,orange!70}]
    ...
    \path (3,2.25) edge node[above] {\footnotesize{$1/\textsf{\#d}$}} (8,2.25);
    ...
    \path (4.5,-0.25) edge node[right] {\footnotesize{$p : \#d \leftrightblackspoon \#c$}} (4.5,-0.75);

    \path (5,0.25) edge node[above] {\footnotesize{$1/\textsf{\#c}$}} (6,0.25);
    \path (5,1.25) edge node[above] {\footnotesize{${\textsf{\#c}}$}} (6,1.25);

    \draw (6,-0.25) -- (7,-0.25) -- (7,1.75) -- (6,1.75) -- cycle;
    \node at (6.5,0.75) {\footnotesize{$\epsilon +$}};

    \path (7,0.75) edge node[above] {\footnotesize{${\#id}$}} (8,0.75);

    \draw (8,0.5) -- (9,0.5) -- (9,2.5) -- (8,2.5) -- cycle;
    \node at (8.5,1.5) {\footnotesize{$\unititl/$}};

    \path (9,1.5) edge node[above] {\footnotesize{$1/{\textsf{\#d}}$}} (10,1.5);
  \end{tikzpicture}
