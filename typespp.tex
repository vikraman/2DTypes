...
groupoid $\iorder{\permfive}$ of cardinality $\frac{1}{3}$ is equivalent
to the trivial
...
\emph{pullback}, where $s,t$ are the \emph{source} and \emph{target} maps,
and $\mathbb{1}$, $\mathbb{3}$ are the $1$- and $3$-point discrete groupoids
defined previously.
The intuition is that the codomain consists of three objects
...
semantics that somehow combines the local and global aspects of the
equivalence. We will be inspired by the folklore result that ``substitution into a
dependent type is a pullback''~\cite{subpullback} (but which turns out to have
...
\begin{figure}[h]
  ...
  \begin{tikzcd}
    ...
    & G \arrow[d, "{(s,t)}"] \\
    & \mathbb{1} \times \mathbb{1} \arrow[r, "{\psi_0 \times \psi_0}"]
...
{\footnotesize
\[\begin{array}{rrcll}
\unitetl/ :&  \forall\overline{k}.[\order{\idiso} \circledast \mathbb{T},
                                                   \langle \idiso,v \rangle]
  & \leftrightblackspoon &
                    \forall\overline{k}.[\mathbb{T},v]
  &: \unititl/ \\
\unitetr/ :&  \forall\overline{k}.[\mathbb{T} \circledast \order{\idiso},
                                                    \langle v,\idiso]
  & \leftrightblackspoon &
                    \forall\overline{k}.[\mathbb{T},v]
  &: \unititr/ \\
\swapt/ :&  \forall\overline{k}.[\mathbb{T}_1 \circledast \mathbb{T}_2,
                                                   \langle v_1,v_2 \rangle]
 & \leftrightblackspoon &
                   \forall\overline{k}.[\mathbb{T}_2 \circledast \mathbb{T}_1,
                                                  \langle v_2,v_1 \rangle]
  &: \swapt/ \\
  \assoclt/ :&  \forall\overline{k}.[\mathbb{T}_1 \circledast (\mathbb{T}_2 \circledast \mathbb{T}_3),
                                        \langle v_1,\langle v_2,v_3 \rangle]
  & \leftrightblackspoon &
                       \forall\overline{k}.[(\mathbb{T}_1 \circledast \mathbb{T}_2) \circledast \mathbb{T}_3,
                                       \langle \langle v_1,v_2 \rangle , v_3 \rangle]
  &: \assocrt/ \\
\\
\eta- :& [\order{\idiso},\idiso] & \leftrightblackspoon &
  \forall{k}.[\iorder{c} \circledast \order{c}, \langle 1/c^k, c^k \rangle] &: \epsilon- \\
\eta+ :& [\order{\idiso},\idiso] & \leftrightblackspoon &
  \forall{k}.[\order{c} \circledast \iorder{c}, \langle c^k,1/c^k \rangle] &: \epsilon+ \\
\end{array}\]
\[\begin{array}{c}
\Rule{}
{}
{\jdg{}{}{\idiso/ : \forall\overline{k}.[\mathbb{T},v] \leftrightblackspoon
  \forall\overline{k}.[\mathbb{T},v]}}
{}
~~
\Rule{}
...
\Rule{}
{\jdg{}{}{\rho_1 :
  \forall{\overline{k_1}}.[\mathbb{T}_1,v_1] \leftrightblackspoon
  \forall{\overline{k_2}}.[\mathbb{T}_2,v_2]}
 \qquad \rho_2 :
  \forall{\overline{k_3}}.[\mathbb{T}_3,v_3] \leftrightblackspoon
  \forall{\overline{k_4}}.[\mathbb{T}_4,v_4]}
{\jdg{}{}{\rho_1 \circledast \rho_2 :
  \forall{\overline{k_1k_2k_3k_4}}.
...
\Rule{}
{\jdg{}{}{}}
{\jdg{}{}{\synch_i : \forall{\overline{k}k'}.[\mathbb{T},v]
  \leftrightblackspoon
   \forall{\overline{k}}.[\mathbb{T},v[k'\mapsto i]]}}
{}
\end{array}\]
...
$\iorder{c}$; they must be ``synchronized'' sharing the same $k$. In general, a
pointed type will be of the form $\forall\overline{k}.[\mathbb{T},v]$ for some
sequence of integers $\overline{k}$ and some value $v$ in $\mathbb{T}$ which
might of course refer to the integers $\overline{k}$ to enforce some
synchronization among its sub-values.
...
&\stackrel{\eta+\circledast\idiso/}{\longmapsfrom}&
  [\order{c}\circledast\order{\idiso}, \langle c^i, \idiso] \\
