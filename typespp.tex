...
\begin{figure}[t]
  \begin{subfigure}{.5\textwidth}
    ...
    \begin{tikzpicture}[scale=0.9,every node/.style={scale=0.7},highlight/.style={line width=4pt,orange!70}]
      ...
      \path (2.5,0) edge node[left] {\footnotesize{$p : \#c \leftrightarrow \#d$}} (2.5,-0.5);
    \end{tikzpicture}
    \caption{\label{fig:name} \texttt{name}}
  \end{subfigure}
  \begin{subfigure}{.5\textwidth}
    \centering
    \begin{tikzpicture}[scale=0.9,every node/.style={scale=0.7},highlight/.style={line width=4pt,orange!70}]
      ...
      \path (0.5,0) edge node[right] {\footnotesize{$p : \#c \leftrightarrow \#d$}} (0.5,-0.5);
      ...
      \draw (2,0) -- (3,0) -- (3,2) -- (2,2) -- cycle;
      \node at (2.5,1) {\footnotesize{$\eta -$}};

      \path (3,1) edge node[above] {\footnotesize{${\textsf{[\#id,id]}}$}} (4,1);
    \end{tikzpicture}
    \caption{\label{fig:coname} \texttt{coname}}
  \end{subfigure}
  \caption{\label{fig:name} \texttt{name} and \texttt{coname}}
\end{figure}
