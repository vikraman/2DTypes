...
Compact closed categories have various interesting notions, such as
duals, name and coname, which eventually lead to a certain notion of 
higher order functions.  Here we show that the first three (duals,
name and coname) are definable circuits in $\Pi^/$.
...
reversible circuit in Figure~\ref{fig:dual}.  The highlights that seem to
...
Figure~\ref{fig:name-coname}.  Like with dual, we need to insert a combinator
$p$ \emph{under} a quantifier.
...
\begin{figure}[htb]
  \begin{subfigure}{.5\textwidth}
    ...
    \begin{tikzpicture}[scale=0.9,every node/.style={scale=0.7},highlight/.style={line width=4pt,orange!70}]
      ...
      \node at (2.5,0.25) {\footnotesize{$p$}};
  ...
  \begin{subfigure}{.5\textwidth}
    ...
    \begin{tikzpicture}[scale=0.9,every node/.style={scale=0.7},highlight/.style={line width=4pt,orange!70}]
      ...
      \node at (0.50,0.25) {\footnotesize{$p^{-1}$}};
