...
{\footnotesize
\[\begin{array}{rrcll}
\unitetl/ :&  \exists\overline{k}.[\order{\idiso} \circledast \mathbb{T},
                                                   \langle \idiso,v \rangle]
  & \leftrightblackspoon &
                    \exists\overline{k}.[\mathbb{T},v]
  &: \unititl/ \\
\unitetr/ :&  \exists\overline{k}.[\mathbb{T} \circledast \order{\idiso},
                                                    \langle v,\idiso]
  & \leftrightblackspoon &
                    \exists\overline{k}.[\mathbb{T},v]
  &: \unititr/ \\
\swapt/ :&  \exists\overline{k}.[\mathbb{T}_1 \circledast \mathbb{T}_2,
                                                   \langle v_1,v_2 \rangle]
 & \leftrightblackspoon &
                   \exists\overline{k}.[\mathbb{T}_2 \circledast \mathbb{T}_1,
                                                  \langle v_2,v_1 \rangle]
  &: \swapt/ \\
  \assoclt/ :&  \exists\overline{k}.[\mathbb{T}_1 \circledast (\mathbb{T}_2 \circledast \mathbb{T}_3),
                                        \langle v_1,\langle v_2,v_3 \rangle]
  & \leftrightblackspoon &
                       \exists\overline{k}.[(\mathbb{T}_1 \circledast \mathbb{T}_2) \circledast \mathbb{T}_3,
                                       \langle \langle v_1,v_2 \rangle , v_3 \rangle]
  &: \assocrt/ \\
\\
\eta- :& [\order{\idiso},\idiso] & \leftrightblackspoon &
  \exists{k}.[\iorder{c} \circledast \order{c}, \langle 1/c^k, c^k \rangle] &: \epsilon- \\
\eta+ :& [\order{\idiso},\idiso] & \leftrightblackspoon &
  \exists{k}.[\order{c} \circledast \iorder{c}, \langle c^k,1/c^k \rangle] &: \epsilon+ \\
\end{array}\]
\[\begin{array}{c}
\Rule{}
{}
{\jdg{}{}{\idiso/ : \exists\overline{k}.[\mathbb{T},v] \leftrightblackspoon
  \exists\overline{k}.[\mathbb{T},v]}}
{}
~~
\Rule{}
...
\Rule{}
{\jdg{}{}{\rho_1 :
  \exists{\overline{k_1}}.[\mathbb{T}_1,v_1] \leftrightblackspoon
  \exists{\overline{k_2}}.[\mathbb{T}_2,v_2]}
 \qquad \rho_2 :
  \exists{\overline{k_3}}.[\mathbb{T}_3,v_3] \leftrightblackspoon
  \exists{\overline{k_4}}.[\mathbb{T}_4,v_4]}
{\jdg{}{}{\rho_1 \circledast \rho_2 :
  \exists{\overline{k_1k_2k_3k_4}}.
...
\Rule{}
{\jdg{}{}{}}
{\jdg{}{}{\synch : \exists{\overline{k}k'}.[\mathbb{T},v]
  \leftrightblackspoon
   [\mathbb{T},v[k'\mapsto ??]]}}
{}
\end{array}\]
...
pointed type will be of the form $\exists\overline{k}.[\mathbb{T},v]$ for some
