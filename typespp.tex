...
We call the new extension $\Pi^/$. We begin by adding four new syntactic categories to the definition of $\Pi$ in Sec.~\ref{opsempi}:
...
(\textrm{//-combinators}) & \varrho &:& \rho_1 \leftrightblackspoon \rho_2 \mbox{~where~}
  \rho_1, \rho_2 : \mathbb{T}_1 \leftrightspoon \mathbb{T}_2 ~::=
  [\textit{see Fig.~\ref{pifrac:twocomb}}]
\end{array}\]
\end{definition}
...
\end{itemize}
that satisfy appropriate coherence conditions. These coherence conditions are
