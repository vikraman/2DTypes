...
{\footnotesize
\[\begin{array}{rrcll}
\unitetl/ :& \quant{\overline{k}}.[\order{\idiso} \circledast \mathbb{T},
                                                   \langle \idiso,v \rangle]
  & \leftrightblackspoon &
                   {\overline{k}}.[\mathbb{T},v]
  &: \unititl/ \\
\unitetr/ :& \quant{\overline{k}}.[\mathbb{T} \circledast \order{\idiso},
                                                    \langle v,\idiso]
  & \leftrightblackspoon &
                   \quant{\overline{k}}.[\mathbb{T},v]
  &: \unititr/ \\
\swapt/ :& \quant{\overline{k}}.[\mathbb{T}_1 \circledast \mathbb{T}_2,
                                                   \langle v_1,v_2 \rangle]
 & \leftrightblackspoon &
                  \quant{\overline{k}}.[\mathbb{T}_2 \circledast \mathbb{T}_1,
                                                  \langle v_2,v_1 \rangle]
  &: \swapt/ \\
  \assoclt/ :& \quant{\overline{k}}.
...
\eta- :& [\order{\idiso},\idiso] & \leftrightblackspoon &
  \quant{k}.[\iorder{c} \circledast \order{c}, \langle 1/c^k, c^k  \rangle]
  & : \epsilon- \\
\eta+ :& [\order{\idiso},\idiso] & \leftrightblackspoon &
  \quant{k}.[\order{c} \circledast \iorder{c}, \langle c^k,1/c^k \rangle]
  & : \epsilon+ \\
\synchl :& \quant{k}.[(\order{c}\circledast\iorder{c})\circledast\order{c},
  \langle \langle c^k,1/c^k \rangle, c^i]
  & \leftrightblackspoon &
  [(\order{c}\circledast\iorder{c})\circledast\order{c},
    \langle \langle c^i,1/c^i \rangle, c^i]
  & : \packl \\
\synchr :& \quant{k}.[\order{c}\circledast(\iorder{c}\circledast\order{c}),
...
\Rule{}
{}
{\jdg{}{}{\idiso/ : \quant{\overline{k}}.[\mathbb{T},v] \leftrightblackspoon
   \quant{\overline{k}}.[\mathbb{T},v]}}
{}
~~
\Rule{}
...
\Rule{}
{\jdg{}{}{\rho_1 :
  \quant{\overline{k_1}}.[\mathbb{T}_1,v_1] \leftrightblackspoon
  \quant{\overline{k_2}}.[\mathbb{T}_2,v_2]} \quad
  \rho_2 :
  \quant{\overline{k_2}}.[\mathbb{T}_2,v_2] \leftrightblackspoon
  \quant{\overline{k_3}}.[\mathbb{T}_3,v_3]}
...
{\jdg{}{}{\rho_1 :
 \quant{\overline{k_1}}.[\mathbb{T}_1,v_1] \leftrightblackspoon
 \quant{\overline{k_2}}.[\mathbb{T}_2,v_2]}
 \qquad \rho_2 :
 \quant{\overline{k_3}}.[\mathbb{T}_3,v_3] \leftrightblackspoon
 \quant{\overline{k_4}}.[\mathbb{T}_4,v_4]}
{\jdg{}{}{\rho_1 \circledast \rho_2 :
  \quant{\overline{k_1k_3}}.[\mathbb{T}_1 \circledast \mathbb{T}_3, \langle v_1,v_3 \rangle]
  \leftrightblackspoon
  \quant{\overline{k_2k_4}}.[\mathbb{T}_2 \circledast \mathbb{T}_4}, \langle v_2,v_4 \rangle]}
{}
\end{array}\]
\\
Each combinator $\rho_\bullet$ has an inverse $\rho_\bullet^{-1}$.
A rule $\mathbb{T_1}_\bullet \leftrightblackspoon
\quant{k}.\mathbb{T_2}_\bullet$ introduces a $\forall$ in the left-to-right
direction and eliminates an $\exists$ in the right-to-left direction. A rule
$\quant{k}.\mathbb{T_1}_\bullet \leftrightblackspoon
...
$\quant{k}.\mathbb{T_1}_\bullet \leftrightblackspoon
\quant{k}.\mathbb{T_2}_\bullet$ maintains (think of elimination then
...
$\quant{\overline{k}}.[\mathbb{T},v]$ where all the quantifiers are
...
depending on which direction the rule is used. We use a $\quant$
...
pointed types with explicit quantifiers and synchronization primitives that are
not present in the conventional setting. Adapting the conventional constructions
requires resolving some subtleties and will provide the first operational
interpretation known to us of multiplicative higher-order recursive functions.
