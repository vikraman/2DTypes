...
\begin{figure}
    \begin{tikzpicture}[scale=0.9,every node/.style={scale=0.7},highlight/.style={line width=4pt,orange!70}]
      ...
      \path (3,2.25) edge node[above] {\footnotesize{$1/\textsf{\#c}$}} (4,2.25);
      \path (3,1.25) edge node[above] {\footnotesize{$\textsf{\#c}$}} (4,1.25);
      \draw[dashed] (3.1,2.25) -- (3.1,1.25);

      \draw (4,0) -- (5,0) -- (5,2.75) -- (4,2.75) -- cycle;
      \node at (4.5,1.375) {\footnotesize{$\synchr$}};

      \path (5,0.25) edge node[above] {\footnotesize{$1/\textsf{\#c}$}} (6,0.25);
      \path (5,1.25) edge node[above] {\footnotesize{${\textsf{\#c}}$}} (6,1.25);
      \path (5,2.25) edge node[above] {\footnotesize{$1/{\textsf{\#c}}$}} (8,2.25);
      \draw[dashed] (5.1,0.25) -- (5.1,1.25);

      \draw (6,-0.25) -- (7,-0.25) -- (7,1.75) -- (6,1.75) -- cycle;
      \node at (6.5,0.75) {\footnotesize{\texttt{cong}}};
      \path (6.5,-0.25) edge node[right] {\footnotesize{$p : 1/\#c \leftrightblackspoon 1/\#d$}} (6.5,-0.75);

      \path (7,0.25) edge node[above] {\footnotesize{$1/{\textsf{\#d}}$}} (10,0.25);
      \path (7,1.25) edge node[above] {\footnotesize{${\textsf{\#c}}$}} (8,1.25);
      \draw[dashed] (7.9,2.25) -- (7.9,1.25);
