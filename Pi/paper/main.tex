...
\begin{abstract}
  ...
  universe, which is shown to be sound and complete for both levels, establishing an equivalence of groupoids. We
  ...
  given by finite sets and bijections. Our proof uses techniques from the theory of permutation codes, group
  presentations and rewriting systems to solve the word problem for symmetric groups.
