...
state our result as a Curry-Howard-Lambek correspondence for Reversible Logic, Reversible Programming Languages, and
Symmetric Rig Groupoids, using which we can build a toolbox of technical devices for reasoning about reversible
circuits.
...
\begin{itemize}[leftmargin=*]
      ...
      \item \cref{sec:ufin} describes the construction of $\UFin$, the groupoid of finite sets and permutations, in
            ...
            group of permutations on $\Fin[n]$.
