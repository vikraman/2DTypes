...
It is folklore that the groupoid of finite sets and permutations is the free symmetric rig groupoid on zero
generators~\cite{laplaza72,kelly74,baez2000finite}. Our main result formally establishes this correspondence by giving an
...
respect to its semantics in the weak symmetric rig groupoid of finite sets and permutations. We state our result as a
Curry-Howard-Lambek correspondence for Reversible Logic, Reversible Programming Languages, and Symmetric Rig Groupoids,
using which we can build a toolbox of technical devices for reasoning about reversible circuits.
...
them in the text. Our accompanying Agda code~\cite{choudhuryArtifactSymmetriesReversible2021} contains the formalisation
of the full syntax, and most of our proofs.
