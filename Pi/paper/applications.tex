...
Solving this problem using the circuit representation is difficult. However, we can observe that all \Afun{toffoli₃} gates
implements even permutations, that is, permutations consisting of an even number of transpositions. On the other
hand, \Afun{toffoli₄} implements an odd permutation. It is an easily proven lemma that any composition of even permutations
...
answer the question by computing the parity of the \Afun{toffoli₄} and all of the \Afun{toffoli₃} gates. 
