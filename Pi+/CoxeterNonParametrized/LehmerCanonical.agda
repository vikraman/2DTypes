...
module Pi+.CoxeterNonParametrized.LehmerCanonical where
...
only-one-canonical↔ cl1 cl2 m1 m2 pm1 pm2 (MC idp (trans≅ x p2)) =
  let ss = transport (λ t → t ≅ _) (≡-sym pm2) x
  in  ⊥-elim (final≅-Lehmer cl2 _ _ idp ss)
only-one-canonical↔ cl1 cl2 m1 m2 pm1 pm2 (MC (trans≅ x p1) p2) =
