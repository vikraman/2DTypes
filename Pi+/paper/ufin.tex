...
and whose morphisms as bijections between finite sets. The semantics interprets types as objects in~$\BFin$,
...
witnessing the equality of the quoted 1-combinators.
