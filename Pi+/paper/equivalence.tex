...
We revisit the examples in~\Cref{sec:examples} but instead of working with circuits operating on sequences of bits, we
...
Our Agda infrastructure provides tools to normalise all programs to their normal form. For \Afun{reset 2} we get:
