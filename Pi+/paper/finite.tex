...
We state and prove a few auxiliary lemmas about how $\FinExcept{n}$ interacts with $\Fin$. \vc{These can be understood
  using simple counting arguments using the pigeonhole principle, but we have to construct the equivalences.}
