...
\begin{enumerate}
  ...
  \item[\labelcref{fig:coxeter-c}] \jk{If the next transposition in the sequence is equal to the the first one, the order of
        operations can be reversed}.

>>>>>>> ee83d6f6650c383d20e046a4ada0de4cb9c42dca
\end{enumerate}
...
the one in the argument. Note that $\FinExcept{n}[i]$ for $i : \Fin[n]$ is a subtype of $\Fin[n]$ and is hence a
set.
