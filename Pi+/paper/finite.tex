...
We would like to give a syntactic presentation for this groupoid. Note that, in $\BFin$, the set of bijections on a
finite set of cardinality $n$ has a group structure -- the identity function is the neutral element, group
multiplication is given by function composition, and the group inverse is given by inverting the bijection. This is the
automorphism group of the finite set, which is also known to be the finite symmetric group $\Sn[n]$.
