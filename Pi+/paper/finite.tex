...
the reduction $[6, 5, 4, 3, 2, 6] \longcox* [5, 6, 5, 4, 3, 2]$ (see~\cref{fig:longcox} for the braid diagram).
...
we desire. It satisfies confluence, that is, the Church-Rosser (diamond) property, and it is strongly normalising, since
it produces a unique normal form. We follow the terminology
...
we can use the following observation relating it to $\cox*$.~\todo{Check Huet's paper for this property.}
