...
\begin{figure}
  ...
  \begin{subfigure}[b]{0.50\textwidth}
    \adjustbox{scale=\scalef,center}{
      % https://q.uiver.app/?q=
      \begin{tikzcd}
        {\tau_3\tau_2\tau_3\tau_1} \\
        && {\tau_3\tau_2\tau_1\tau_3} \\
        {\tau_2\tau_3\tau_2\tau_1}
        \arrow["\braid"', squiggly, from=1-1, to=3-1]
        \arrow["\braid", squiggly, from=1-1, to=2-3]
        \arrow["{\longbraid}", squiggly, from=2-3, to=3-1]
      \end{tikzcd}
    }
    \caption{Non-converging critical pairs converging in $\longcox*$}
    \label{fig:critical-pairs-non-converging}
  \end{subfigure}
