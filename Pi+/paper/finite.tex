...
\jk{TODO an example here}
To remind ourselves, in a Lehmer code, the element $\el{r}$ at postition $k$ counts the number of inversions of the
element $\el{r}$. This corresponds exactly to what happens in the \cref{prop:fin-finexcept-3}. Looking at the operation
combinatorially, it is inserting element $\el{r}$ at the position $k$, meaning that it shifts the element
$k$places.\jk{needs rewriting after the example is here}
