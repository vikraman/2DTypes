...
\title{Curry-Lambek Correspondence for Reversible Circuits}
...
\begin{abstract}
  ...
  two perspectives match but a full proof of this statement requires a non-trivial construction to establish that the \emph{free
    symmetric rig groupoid} (the syntax of the two level programming language) is equivalent to the \emph{symmetric rig
    of finite sets and bijections} (the categorification of the symmetric groups on finite sets).
