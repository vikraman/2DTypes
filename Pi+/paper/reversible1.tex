...
permutations of finite sets provides a richer algebraic model which we review in this section.
...
A specialized language for programming with permutations on finite sets can be built using ideas going back to Kelly,
...
\begin{proof}
  ...
  $\denot{!c}$ is an equivalence. For the level-2 combinator \Afun{idr◎l}, we check
