...
module Pi+.Coxeter.NonParametrized.ImpossibleLists where
...
repeat-long-lemma-rev : (n k n1 : ℕ) -> (l r : Listℕ) -> (n ↑ k) == (l ++ n1 ∷ n1 ∷ r) -> ⊥
...
incr-long-lemma-rev : (n k n1 k1 : ℕ) -> (S k1 < n1) -> (l r : Listℕ) -> (n ↑ k) == (l ++ k1 ∷ n1 ∷ r) -> ⊥
...
incr-long-lemma : (n k n1 k1 : ℕ) -> (S k1 < n1) -> (l r : Listℕ) -> (n ↓ k) == (l ++ n1 ∷ k1 ∷ r) -> ⊥
...
dec-long-lemma-rev : (n k n1 k1 : ℕ) -> (n1 ≤ k1) -> (l r : Listℕ) -> (n ↑ k) == (l ++ k1 ∷ n1 ∷ r) -> ⊥
...
less-than-↓ : (n k o : ℕ) -> (k + n ≤ o) -> (l r : Listℕ) -> (n ↓ k) == (l ++ (o ∷ r)) -> ⊥
...
repeat-spaced-long-lemma : (n k o o1 : ℕ) -> (o ≤ o1) -> (l r1 r2 : Listℕ) -> (n ↓ k) == (l ++ (o ∷ r1) ++ (o1 ∷ r2)) -> ⊥
...
repeat-spaced2-long-lemma : (n k n1 k1 n2 k2 o : ℕ) -> (S o < k1 + n1) -> (k2 + n2 ≤ o) -> (k + n < k1 + n1) -> (l r : Listℕ) -> (n ↓ k) ++ (n1 ↓ k1) == (l ++ (n2 ↓ S k2) ++ o ∷ r) -> ⊥
...
repeat-↓-long-lemma-r : (n k n1 k1 n2 k2 : ℕ) -> (k + n < k1 + n1) -> (r : Listℕ) -> (n ↓ k) ++ (n1 ↓ k1) == ((n2 ↓ S k2) ++ (k2 + n2) ∷ r) -> ⊥
...
repeat-↓-long-lemma : (n k n1 k1 n2 k2 : ℕ) -> (k + n < k1 + n1) -> (l r : Listℕ) -> (n ↓ k) ++ (n1 ↓ k1) == (l ++ (n2 ↓ S k2) ++ (k2 + n2) ∷ r) -> ⊥
...
++-nonempty-abs : {n : ℕ} -> (l r : Listℕ) -> nil == l ++ n ∷ r -> ⊥
